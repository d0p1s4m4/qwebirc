...
class QWebIRCClient(basic.LineReceiver):
    ...
    def connectionMade(self):
        ...
        nick, ident, ip = f["nick"], f["ident"], f["ip"]
        realname, hostname, pass_ = f["realname"], f["hostname"], f.get("password")
    ...
    def __str__(self):
        return "<QWebIRCClient: %s!%s@%s>" % (
            self.__nickname, self.factory.ircinit["ident"], self.factory.ircinit["ip"])
